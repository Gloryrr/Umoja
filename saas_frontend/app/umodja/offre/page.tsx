...
const ExtrasForm: React.FC<{
    ...
    const handleChange = (e: React.ChangeEvent<HTMLInputElement | HTMLTextAreaElement>) => {
        ...
        onChange(0, { ...extrasData, [name]: value });
    };
        ...
        <div className='mt-10 mb-10 w-[70%]'>
            <form onSubmit={handleSubmit} className="w-full mx-auto bg-white shadow-md rounded-lg p-8 space-y-4">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    ...
                    <div className="col-span-full flex flex-col">
                        <label htmlFor="descrExtras" className="text-gray-700">Description des Extras:</label>
                        <textarea
                            id="descrExtras"
                            name="descrExtras"
                            value={formData.extras.descrExtras}
                    ...
                    <div className="flex flex-col">
                        ...
                        <input
                            ...
                            id="coutExtras"
                            name="coutExtras"
                            value={formData.extras.coutExtras}
                            onChange={handleExtrasChange}
                            required
                            placeholder="Coût des extras"
                            className="mt-1 px-3 py-2 border rounded-lg text-gray-800 focus:outline-none focus:ring focus:border-blue-300"
                    ...
                    <div className="flex flex-col">
                        <label htmlFor="exclusivite" className="text-gray-700">Exclusivité:</label>
                        <input
                            type="text"
                            id="exclusivite"
                            name="exclusivite"
                            value={formData.extras.exclusivite}
                            onChange={handleExtrasChange}
                            required
                            placeholder="Exclusivité"
                            className="mt-1 px-3 py-2 border rounded-lg text-gray-800 focus:outline-none focus:ring focus:border-blue-300"
                    ...
                    <div className="flex flex-col">
                        <label htmlFor="exception" className="text-gray-700">Exceptions:</label>
                        <input
                            type="text"
                            id="exception"
                            name="exception"
                            value={formData.extras.exception}
                            onChange={handleExtrasChange}
                            required
                            placeholder="Exceptions"
                            className="mt-1 px-3 py-2 border rounded-lg text-gray-800 focus:outline-none focus:ring focus:border-blue-300"
                    ...
                    <div className="flex flex-col">
                        ...
                        <input
                            ...
                            id="ordrePassage"
                            name="ordrePassage"
                            value={formData.extras.ordrePassage}
                            onChange={handleExtrasChange}
                            required
                            placeholder="Ordre de passage"
                            className="mt-1 px-3 py-2 border rounded-lg text-gray-800 focus:outline-none focus:ring focus:border-blue-300"
                    ...
                    <div className="flex flex-col">
                        ...
                        <input
                            ...
                            name="clausesConfidentialites"
                            value={formData.extras.clausesConfidentialites}
                            onChange={handleExtrasChange}
                            required
                            placeholder="Clauses de confidentialité"
                            className="mt-1 px-3 py-2 border rounded-lg text-gray-800 focus:outline-none focus:ring focus:border-blue-300"
                    ...
                    <div className="col-span-full flex flex-col">
                        ...
                        <input
                            ...
                            id="minimumGaranti"
                            name="minimumGaranti"
                            value={formData.conditionsFinancieres.minimumGaranti}
                    ...
                    <div className="flex flex-col">
                        ...
                        <input
                            ...
                            value={formData.conditionsFinancieres.conditionsPaiement}
                            onChange={handleConditionsChange}
                            required
                    ...
                    <div className="flex flex-col">
                        ...
                        <input
                            ...
                            value={formData.conditionsFinancieres.pourcentageRecette}
                            onChange={handleConditionsChange}
                            required
                            placeholder="15%"
                            className="mt-1 px-3 py-2 border rounded-lg text-gray-800 focus:outline-none focus:ring focus:border-blue-300"
